/*
 * $Id: patricia.h,v 1.1.1.1 2006/10/18 16:57:05 jacka Exp $
...
typedef struct _patricia_node_t {
    ...
    struct _patricia_node_t *l,
                   *r;          /* left and right children */
    struct _patricia_node_t *parent;    /* may be used */
    void           *data;       /* pointer to data */
    void           *user1;      /* pointer to usr data (ex. route flap
                                 * info) */
} patricia_node_t;
...
patricia_node_t *patricia_search_best(apr_pool_t *,
                                      ...
                                      prefix_t * prefix);
patricia_node_t *patricia_search_best2(apr_pool_t *,
                                       patricia_tree_t * patricia,
                                       prefix_t * prefix, int inclusive);
patricia_node_t *patricia_lookup(apr_pool_t * pool,
                                 patricia_tree_t * patricia,
                                 prefix_t * prefix);
