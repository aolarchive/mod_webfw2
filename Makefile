...
APXS_BIN     = ~/sandboxes/sandbox-2.2.11/bin/apxs 

THRASHER     = -DWITH_THRASHER
DFLAGS       = -Lconfuse-2.5/src -DDEBUG -Wall -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 $(THRASHER)
...
patricia.o: patricia.c 
	gcc -fPIC $(DFLAGS) $(APR_INCLUDES) -c -o patricia.o patricia.c -ggdb 

filter.o: filter.c 
	gcc -fPIC $(DFLAGS) $(APR_INCLUDES) -I. -Iconfuse-2.5/src/ -c -o filter.o filter.c -ggdb 

thrasher.o: thrasher.c thrasher.h
	gcc -fPIC $(DFLAGS) $(APR_INCLUDES) -I. -c -o thrasher.o thrasher.c -ggdb
...
filter: filter.c filter.o patricia.o libconfuse archives
	gcc  -fPIC -DDEBUG -DTEST_FILTERCLOUD $(DFLAGS) -I. -L. $(APR_INCLUDES) $(APR_LIBS) -Iconfuse-2.5/src/ filter.c -o filter -lpatricia -lapr-1 -lconfuse -ggdb
